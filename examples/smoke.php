 ...
 *
 * Prerequisites:
 *   - auth.stromcom.cz dev server running (composer serve → http://localhost:8003)
 *   - a service-account client created with:
 *       composer client:create -- --project=auth --name=foo --service-account
 *
 * Run with:
